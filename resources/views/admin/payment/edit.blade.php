    ...
    <div class="card-body">
            ...
            <section class="invoice">
              ...
              <div class="row mt-3">
                ...
                <div class="col-lg-6">
                 <h5 class="float-sm-right">Date: {{ date('dS-F-Y', strtotime($pay->created_at)) }}</h5>
                </div>
              </div>
            ...
            <hr>
              <div class="row">
                ...
                <div class="col-lg-6">
                  <p class="lead">Amount Due {{ date('dS-F-Y') }}</p>
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        ...
                        <td>
                            <input type="text" name="amount" autofocus class="form-control form-control-square"  placeholder="Enter Amount">
                        </td>
                      </tr>
                      <tr>
