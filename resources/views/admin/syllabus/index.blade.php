    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header text-uppercase">
            <i class="fa fa-table"></i> Syllabi list
            <a href="{{ route('admin.syllabus.create') }}" class="btn btn-info float-right px-5"> 
              <i class="fa fa-plus"> New Unit Syllabus</i>
            </a>
        </div>
        <div class="card-body">
            ...
            <tbody>
                @foreach ($syllabi as $key=>$syllabus)
                    <tr>
                        ...
                        <td>{{ date('dS-M-Y', strtotime($syllabus->created_at)) }}</td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group m-1" role="group">
                                ...
                                <div class="dropdown-menu">
                                  <a href="{{ route('admin.syllabus.edit', $syllabus->id) }}" class="dropdown-item">EDIT</a>
                                  <div class="dropdown-divider"></div>
                                  <a href="{{ route('admin.syllabus.show', $syllabus->id) }}" class="dropdown-item">VIEW/APPROVE</a>
                                </div>
                              </div>
                        </td>
                    </tr>
