       ...
       <div class="profile-card-3">
        <div class="card">
         <div class="user-fullimage">
           <img src="{{ asset('images/users/'.$user->profile_picture) }}" alt="user avatar" class="card-img-top">
            <div class="details">
              <h5 class="mb-1 text-white ml-3">{{ $user->name }}</h5>
              <h6 class="text-white ml-3">{{ $user->role->name }}</h6>
             </div>
          </div>
                ...
                <table class="table table-hover table-striped">
                    <tbody>
                        ...
                        <tr>
                         ...
                         <td>
                            <a href="{{ route('admin.message.show', $message->id) }}" class="btn btn-info px-3 shadow-ifo">
                                Read Message
                            </a>
                         </td>
                        @empty
            ...
            <div class="tab-pane active" id="edit">
                <form action="{{ route('admin.user.update', $user->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="name" class="form-control" readonly type="text" value="{{ $user->name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label">Email</label>
                        <div class="col-lg-9">
                            <input name="email" class="form-control" type="text" readonly value="{{ $user->email }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label">Address</label>
                        <div class="col-lg-9">
                            <input name="city" class="form-control" type="text" readonly value="{{ $user->city }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label">Phone number</label>
                        <div class="col-lg-9">
                            <input name="phone" class="form-control" type="text" readonly value="{{ $user->phone_no }}">
                        </div>
                    </div>
                    {{-- <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea name="about" class="form-control" rows="5" readonly>
                                {!! $user->about !!}
                            </textarea>
                        </div>
                    </div>
