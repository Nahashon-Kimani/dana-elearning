...
<hr>
       <div class="card">
         <div class="card-body">
           ...
           <hr>
            <form action="{{ route('lecturer.lesson.update',$lesson->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="video" class="form-control form-control-square" id="input-13" value="{{ $lesson->featured_video }}">
                       </div>
