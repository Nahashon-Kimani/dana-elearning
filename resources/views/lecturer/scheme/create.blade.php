    ...
    <hr>
       <div class="card">
         <div class="card-body">
           ...
           <hr>
            <form action="{{ route('lecturer.scheme.store') }}" method="POST">
                @csrf
             ...
             <div class="form-group">
              ...
              <textarea name="desc" id="summernote" rows="5"></textarea>
             </div>
             <div class="form-group">
                <a href="{{ route('lecturer.scheme.index') }}" class="btn btn-warning shadow-warning btn-square px-5">Cancel</a>
