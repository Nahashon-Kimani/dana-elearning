    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header text-uppercase">
            ...
            <a href="{{ route('lecturer.scheme.create') }}" class="btn btn-info float-right">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group m-1" role="group">
                                    ...
                                    <div class="dropdown-menu">
                                      <a href="{{ route('lecturer.scheme.edit', $scheme->id) }}" class="dropdown-item">EDIT</a>
                                        <div class="dropdown-divider"></div>
                                      <a href="{{ route('lecturer.scheme.show', $scheme->id) }}" class="dropdown-item">VIEW</a>
                                    </div>
                                  </div>
                            </td>
                        </tr>
