    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header text-uppercase">
            ...
            <a href="{{ route('lecturer.exercise.create') }}" class="btn btn-info shadow-info float-right text-uppercase">
                                ...
                                <div class="btn-group m-1" role="group">
                                    ...
                                    <div class="dropdown-menu" style="">
                                      @if ($assignment->status == 1)
                                          <div class="dropdown-divider"></div>
                                      @else
                                          <a href="{{ route('lecturer.exercise.edit', $assignment->id) }}" class="dropdown-item">EDIT</a>
                                          <div class="dropdown-divider"></div>
                                      @endif
                                      {{-- <a href="javaScript:void();" class="dropdown-item">QUICK VIEW</a>
                                      <div class="dropdown-divider"></div> --}}
                                      <a href="{{ route('lecturer.exercise.show', $assignment->id) }}" class="dropdown-item">VIEW</a>
                                    </div>
                                  </div>
                            </td>
                        </tr>
