           ...
           <hr>
            <form action="{{ route('lecturer.exercise.update', $exercise->id) }}" method="POST">
             ...
             <div class="form-group">
              ...
              <textarea name="content" id="summernote" rows="4">{!! $exercise->content !!}</textarea>
             </div>
           
             <div class="form-group">
                 <a href="{{ route('lecturer.exercise.index') }}" class="btn btn-warning shadow-warning btn-square px-5 text-uppercase">Cancel</a>
              <button type="submit" class="btn btn-info shadow-info btn-square px-5 text-uppercase"><i class="icon-lock"></i> Update</button>
            </div>
            </form>
         </div>
       </div>
