    ...
    <nav class="navbar navbar-expand fixed-top gradient-scooter color-header">
     <ul class="navbar-nav mr-auto align-items-center">
       ...
       {{-- <li class="nav-item">
        ...
        {{-- if an admin then he can be able to see messages and questions sent 
        if instructor, then can be able to see questions only --}}
           ...
           <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center">
             ...
             <a href="javaScript:void();">
              <div class="media">
                <div class="avatar"><img class="align-self-start mr-3" src="{{ asset('backend/assets/images/avatars/avatar-1.png') }}" alt="user avatar"></div>
             ...
             <a href="javaScript:void();">
              <div class="media">
                <div class="avatar"><img class="align-self-start mr-3" src="{{ asset('backend/assets/images/avatars/avatar-2.png') }}" alt="user avatar"></div>
               <div class="media-body">
             ...
             <a href="javaScript:void();">
              <div class="media">
                <div class="avatar"><img class="align-self-start mr-3" src="{{ asset('backend/assets/images/avatars/avatar-3.png') }}" alt="user avatar"></div>
               <div class="media-body">
             ...
             <a href="javaScript:void();">
              <div class="media">
                <div class="avatar"><img class="align-self-start mr-3" src="{{ asset('backend/assets/images/avatars/avatar-4.png') }}" alt="user avatar"></div>
               <div class="media-body">
